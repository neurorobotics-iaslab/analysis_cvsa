...
avg = 1;
eog_threshold = 500;
channels_select = {'PZ', 'POZ', 'O1', 'O2', 'OZ'};
...
for idx_file= 1: nFiles
    ...
    signals = cat(1, signals, c_signal(:,:));
...
for idx_ch = 1:nchannelsSelected
    ...
    compute_theta_peak_v3_1Dcursor(eegEpochs_pre, params, false, true, true, channelsSelected(idx_ch), channels_label{channelsSelected(idx_ch)});
end
