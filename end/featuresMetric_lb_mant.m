...
title([subject ' | fisher score for [-' num2str(interval(1)) ':+' num2str(interval(2)) '] | CALIBRATION FILES']);
path_figure = ['/home/paolo/cvsa_ws/img_results/27_features/' subject '/trainFile_sus/fisher.svg'];
...
path_figure = ['/home/paolo/cvsa_ws/img_results/27_features/' subject '/trainFile_sus/features_allxw.svg'];
