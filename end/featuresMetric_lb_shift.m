...
for idx_interval = 1:nInterval
    ...
    for idx_ch=1:nchannelsSelected
        ...
        for idx_band=1:nbands
            mean_c1(idx_ch, idx_band) = mean(trial_data_train(minDurCue-c_interval:minDurCue+c_interval,idx_band,idx_chSel,trial_typ_train == classes(1)), 'all');
            mean_c2(idx_ch, idx_band) = mean(trial_data_train(minDurCue-c_interval:minDurCue+c_interval,idx_band,idx_chSel,trial_typ_train == classes(2)), 'all');
            std_c1(idx_ch, idx_band) = std(trial_data_train(minDurCue-c_interval:minDurCue+c_interval,idx_band,idx_chSel,trial_typ_train == classes(1)), 0, 'all');
            std_c2(idx_ch, idx_band) = std(trial_data_train(minDurCue-c_interval:minDurCue+c_interval,idx_band,idx_chSel,trial_typ_train == classes(2)), 0, 'all');
        end
    end
